...
{{
  ...
  "summary_ja": "元記事の情報をできる限り100%に近い形で日本語化する。省略・要約はしない。段落ごとに改行(\\n)を入れる。",
  "category": "カテゴリ名",
  "hashtags": ["#TagOne", "#TagTwo", "#TagThree"],
  "off_topic": false,
  "x_post": "X（Twitter）投稿用の要約。記事の核心を1-2文で伝える。140字以内。URLやハッシュタグは含めない。読者が反応したくなる書き方で、ニュースの結論や意外性を先に出す。",
  "threads_post": "Threads投稿用の要約。記事の要点を3-4文で分かりやすく伝える。400字程度。URLやハッシュタグは含めない。読者が記事を読みたくなるような書き方。"
}}
